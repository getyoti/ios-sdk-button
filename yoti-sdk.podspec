#
#  Be sure to run `pod spec lint ios-sdk-button.podspec' to ensure this is a
...
This repo contains the tools and step by step instructions so that your users can share their identity details with your application in a secure and trusted way.
  ...
  s.author             = { "Yoti Ltd" => "hello@yoti.com" }
  # Or just: s.author    = "Yoti Ltd"
  # s.authors            = { "Yoti Ltd" => "hello@yoti.com" }
  s.social_media_url   = "http://twitter.com/getyoti"
